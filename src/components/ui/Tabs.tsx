...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            'inline-flex h-12 items-center justify-center rounded-xl bg-[var(--wat-surface)] p-1 text-[var(--wat-text-muted)]',
            className
        )}
        {...props}
    />
